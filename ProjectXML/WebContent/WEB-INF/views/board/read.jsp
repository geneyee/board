		...
		<div class="col-sm-6">
			<div class="card shadow">
				<div class="card-body">
					...
					<c:if test="${readContentBean.content_file != null }"><!-- 첨부파일이 있을 경우에만 나오도록 -->
					<div class="form-group">
					...
					<div class="form-group">
						<div class="text-right">
							...
							<!-- 수정이나 삭제하고 난 후 다시 게시판으로 돌아와야 하기 때문에 board_info_idx 필요 -->
							</c:if><!-- 로그인 한 유저 idx와 글 작성자 idx가 같을 경우만 수정 삭제 -->
						</div>
					</div>
				</div>
			</div>
